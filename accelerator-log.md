...
```json
{
  "projectName" : "java-web-app-v3",
  "repositoryPrefix" : "harbor.trvharbor.com/supply-chain-images"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->java-web-app-v3]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->harbor.trvharbor.com...(truncated)]
